 ...
 *   - Receipt, Book a mechanic, Chat to us, Visit the help centre —
 *     no backend endpoints exist for these yet; buttons are inert
 *     placeholders (logged to console) until you build them out.
 */
