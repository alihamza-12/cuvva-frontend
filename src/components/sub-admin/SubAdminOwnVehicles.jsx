        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-4 border-b border-[#1e2238]">
          <div>
            ...
            <p className="text-xs text-[#6b7280] mt-1">
              Operational assets owned in your scope.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      className="w-full min-h-[44px] rounded-xl bg-[#060814] border border-[#1e2238] text-[#8a8fbc] font-bold text-xs uppercase tracking-wider hover:border-[#00f0ff] hover:text-white transition-all"
                    >
                      View Details
                    </button>
                  </div>
